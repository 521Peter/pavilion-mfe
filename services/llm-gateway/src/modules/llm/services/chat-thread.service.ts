    ...
    await this.prisma.$transaction([
      this.prisma.chatMessage.upsert({
        ...
        create: {
          ...
          payload: toPrismaJson(data.message),
          ...(data.runConfig ? { runConfig: toPrismaJson(data.runConfig) } : {})
        },
        update: {
          parentId: data.parentId ?? null,
          payload: toPrismaJson(data.message),
          runConfig: data.runConfig ? toPrismaJson(data.runConfig) : Prisma.JsonNull
        }
      }),
