...
async function bootstrap(): Promise<void> {
  ...
  // oxlint-disable-next-line typescript/no-unsafe-type-assertion -- Nest Swagger's OpenAPIObject is the runtime document consumed by the local gateway parser despite its legacy narrower DocumentType declaration
