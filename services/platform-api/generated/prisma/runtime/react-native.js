...
var Ve = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
  ...
  ni = (e, t, r, n) => {
    if ((t && typeof t == "object") || typeof t == "function")
      for (let i of wa(t))
        !xa.call(e, i) && i !== r && rr(e, i, { get: () => t[i], enumerable: !(n = ya(t, i)) || n.enumerable });
    return e;
  };
var Qe = (e, t, r) => (
    (r = e != null ? ha(ba(e)) : {}),
      ...
      function g(C) {
        ...
        for (U = 0; U < Y; U += 4)
          ((S =
            ...
            (k[q++] = S & 255));
        return (
          L === 2 && ((S = (r[C.charCodeAt(U)] << 2) | (r[C.charCodeAt(U + 1)] >> 4)), (k[q++] = S & 255)),
          L === 1 &&
            ((S = (r[C.charCodeAt(U)] << 10) | (r[C.charCodeAt(U + 1)] << 4) | (r[C.charCodeAt(U + 2)] >> 2)),
            (k[q++] = (S >> 8) & 255),
            (k[q++] = S & 255)),
          k
        );
...
R.logarithm = R.log = function (e) {
  ...
  if (
    ...
    do
      if (((a += 10), (s = Ne(u, a)), (n = t ? yr(g, a + 10) : Ne(e, a)), (l = $(s, n, a, 1)), !o)) {
...
function Ne(e, t) {
  ...
  for (h = S, l = s = S = $(S.minus(1), S.plus(1), g, 1), T = I(S.times(S), g, 1), i = 3; ;) {
    if (((s = I(s.times(T), g, 1)), (u = l.plus($(s, new _(i), g, 1))), Z(u.d).slice(0, g) === Z(l.d).slice(0, g)))
      if (
        ((l = l.times(2)),
  ...
  if (
    ...
    if (!h[0]) g = C ? "0p+0" : "0";
      ...
      if (
        (s < 0
          ? o--
          : ((e = new O(e)), (e.d = h), (e.e = o), (e = $(e, T, r, n, 0, i)), (h = e.d), (o = e.e), (u = ro)),
        (s = h[r]),
        (a = i / 2),
        (u = u || h[r + 1] !== void 0),
        (u =
...
function Nn(e, t) {
  e === void 0 &&
    t.isPreviewFeatureOn("strictUndefinedChecks") &&
    t.throwValidationError({ kind: "InvalidSelectionValue", selectionPath: t.getSelectionPath(), underlyingError: Uo });
}
var Ln = class e {
  constructor(t) {
    this.params = t;
