...
export class AgentToolService {
    ...
    async listActiveTools(allowedNames?: ReadonlySet<string>): Promise<StructuredToolInterface[]> {
        const servers = (await this.serverService.listRuntime()).filter((server) => server.isActive);
