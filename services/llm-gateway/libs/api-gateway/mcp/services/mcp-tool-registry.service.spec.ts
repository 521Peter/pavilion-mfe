...
function createService(
  ...
  return new McpToolRegistryService(openApiService, { enabled: true, ...mcpOption }, { apiServices: [] } as never);
}

const asInternal = (
  service: McpToolRegistryService
): {
  buildDefaultToolName(serviceName: string, method: string, operationId: string | undefined, path: string): string;
